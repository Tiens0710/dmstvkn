  ...
  const handleSupport = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Email', onPress: () => Linking.openURL('mailto:support@finwise.app') },
        { text: 'Website', onPress: () => Linking.openURL('https://finwise.app') },
    ...
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.profileSection}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 20, gap: 0 }}>
          {[['18.5M', 'Thu/tháng', '#059669'], ['8.4M', 'Chi/tháng', '#DC2626'], ['10.1M', 'Tiết kiệm', '#4F46E5']].map(([val, lbl, clr], i) => (
            <View key={lbl} style={{ flex: 1, alignItems: 'center', borderLeftWidth: i > 0 ? 1 : 0, borderLeftColor: colors.border }}>
              <Text style={{ fontSize: 16, fontWeight: 'bold', color: clr as string }}>{val as string}đ</Text>
              <Text style={{ fontSize: 10, color: colors.textSecondary, marginTop: 2 }}>{lbl as string}</Text>
            </View>
          ))}
        </View>
      </View>
      ...
      <View style={[styles.menuContainer, { backgroundColor: colors.card }]}>
        ...
        <TouchableOpacity style={[styles.menuItem, { backgroundColor: colors.menuItemBackground, borderBottomColor: colors.border }]} onPress={() => Linking.openURL('https://finwise.app/privacy')}>
          <View style={[styles.menuIconContainer, { backgroundColor: colors.menuIconBackground }]}>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, styles.aboutModal]}>
            ...
            <View style={styles.aboutLogo}>
              <Icon name="account-balance-wallet" size={50} color="#4F46E5" />
            </View>

            <Text style={styles.aboutAppName}>FinWise</Text>
            ...
            <View style={styles.aboutInfo}>
              <View style={styles.aboutInfoRow}>
                ...
                <Text style={styles.aboutInfoText}>FinWise Team</Text>
              </View>
              <View style={styles.aboutInfoRow}>
                <Icon name="email-outline" size={18} color="#666" />
                <Text style={styles.aboutInfoText}>support@finwise.app</Text>
              </View>
              <View style={styles.aboutInfoRow}>
              ...
              <View style={styles.aboutInfoRow}>
                ...
                <Text style={styles.aboutInfoText}>www.finwise.app</Text>
              </View>
            </View>
            ...
            <Text style={styles.aboutDescription}>
              FinWise – Ứng dụng quản lý tài chính cá nhân thông minh. Theo dõi chi tiêu, lập ngân sách,
              đặt mục tiêu tiết kiệm và phân tích sức khoẻ tài chính của bạn mọi lúc mọi nơi.
            </Text>
